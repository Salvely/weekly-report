...
- DDCA 数字逻辑部分学习
- Vivado + Vscode 配置
- Logisim 实现基础电路，学习异步时序逻辑电路设计，FSM 设计及状态简化
- DFA 学习
- 微分方程的解法复习
- 离散数学复习
- 自定义小型推理引擎 tie 实现起步
...
- [2024.5.20](./week30/journal/day1.md): 异面直线距离公式推导
- [2024.5.21](./week30/journal/day2.md): 进行了基地坐标系互转的公式推导
- 2024.5.22-2024.5.25: 博客功能完善，网站提交，访客优化，搜索功能修复，Ron Larson 笔记格式完善，向量值函数部分公式推导
- [2024.5.26](./week30/journal/day7.md): 完善博客上的 Projects 内容，完善更多数学笔记

## Week 31: 2024.5.27-2024.6.2

### 主要任务

### Logs

- 2024.5.27-2024.5.28：Ron Larson Calculus 弧长和曲率公式学习
- [2024.5.29](./week31/journal/day3.md): 省人民医院甲床分离看病，例假第一天，很困很累
...
## Week 36-37: 2024.9.28-2024.10.13

### 主要任务

### Logs

- [2024.9.28](./week1/day1.md): 等基数的集合构造、利用算术基本定理证明集合可数、集合基数比较和`Cantor-Bernstein-Schröder Theorem`学习（尚未完全完成）
- [2024.9.29](./week1/day2.md): 平板支撑 30s 几乎无痛达成, Book of proof 最后只剩下几道题，离散数学教材搜集完成，看了会儿球赛和无敌破坏王
- 2024.9.30: 徒步+骑行 4 小时，实数的编码方法掌握，从$\mathbb{N}$到$\{0,1\}$的映射含义掌握，Book of proof 最后几题做完，实现严谨的证明过程
- [2024.10.1](./week1/day4.md): Book of proof 最后几个证明完成了，Susanna 的离散数学第一章读了 3 节，回家以后睡了两个小时，起来以后看了几场球赛和《功夫熊猫》
- 2024.10.2-2024.10.6: 休息，期间顺带去看望爷爷奶奶，并且利用 DoIt 主题搭建了[个人博客](https://salvely.github.io)
